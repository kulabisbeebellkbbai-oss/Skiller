    ...
    async with streamablehttp_client(endpoint) as (read, write, _session_id):
        async with ClientSession(read, write) as session:
            ...
            required = {
                ...
                "record_skill_run",
                "recommend_skills",
                "record_guidance_recommendation",
                "get_thread_guidance_context",
                "evaluate_guidance_adherence",
                ...
                "scan_memory_records",
                "memory_scan_due",
                "get_learning_memory_context",
                "record_overseer_guidance",
                "apply_overseer_guidance",
